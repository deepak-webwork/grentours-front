...
function HotelsListContent() {
    ...
    }, [priceLimit, selectedStars, selectedAmenities, selectedRegions, searchQuery, sortOption]);
                                ...
                                hotels.map((hotel, index) => {
                                    return (
                                        <React.Fragment key={hotel.id}>
                                            <Link href={`/hotels/${hotel.slug}`} className="package-card-premium text-decoration-none text-dark">
                                                {/* Card Image */}
                                                    ...
                                                    <div className="inclusions-row mt-3">
                                                        ...
                                                        {hotel.amenities.length > 5 && (
                                                            <span className="inclusion-item text-success fw-bold">
                                                                <i className="bi bi-plus-circle-fill"></i> {hotel.amenities.length - 5} more
                                                            </span>
                                                        )}
                                                    </div>
                                                </div>
